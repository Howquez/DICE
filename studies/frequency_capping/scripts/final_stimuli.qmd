...
# write.csv(tmp, "../stimuli/to-be-supervized.csv", row.names = FALSE, fileEncoding = "UTF-8")
...
sequence <- seq(from = 1, to = length + 5, by = 1)
sequence <- sequence[-seq(from = 6, to = length, by = 11)]
