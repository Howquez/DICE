...
SESSION_CONFIG_DEFAULTS = dict(
    ...
    data_path= 'DICE/static/data/9gag.csv', # 'DICE/static/data/sample_tweets.csv', # "https://raw.githubusercontent.com/Howquez/DICE/main/studies/frequency_capping/stimuli/brazil_pretest.csv",
    delimiter=';',
    sort_by='datetime',
