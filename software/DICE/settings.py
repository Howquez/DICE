...
SESSION_CONFIG_DEFAULTS = dict(
    ...
    data_path='DICE/static/data/marathon_tweets.csv', # 'https://raw.githubusercontent.com/Howquez/oFeeds/main/software/DICE/DICE/static/data/sample_tweets.csv', #'DICE/DICE/data/sample_tweets.csv',
    sort_by='datetime',
