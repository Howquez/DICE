...
11. Click _Upload_ and wait up to a few minutes.
...
15. Click on the link provided in the upper third of the page, that is, `https://[your app name].herokuapp.com`. This will yield the same interface as if you tested the study locally on a devserver.
